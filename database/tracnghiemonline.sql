...
INSERT INTO `cauhoi` (`macauhoi`, `noidung`, `dokho`, `mamonhoc`, `machuong`, `nguoitao`, `trangthai`, `loai`) VALUES
(1, 'Thẻ HTML nào dùng để tạo liên kết?', 1, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(2, 'CSS selector nào chọn tất cả các phần tử?', 1, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(3, 'Làm thế nào để thêm JavaScript vào HTML?', 2, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(4, 'Framework nào phổ biến cho phát triển web?', 2, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(5, 'Mục đích của thuộc tính alt trong thẻ img?', 1, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(6, 'HTML5 có tính năng gì mới?', 2, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(7, 'Thẻ meta dùng để làm gì?', 1, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(8, 'Cách khai báo DOCTYPE trong HTML5?', 1, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(9, 'Thẻ div thuộc loại thẻ nào?', 1, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(10, 'Semantic HTML là gì?', 2, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(11, 'Thẻ header dùng để làm gì?', 1, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(12, 'Cách nhúng file CSS vào HTML?', 2, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(13, 'Thẻ canvas trong HTML5 dùng để gì?', 3, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(14, 'Web storage trong HTML5 là gì?', 3, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(15, 'Geolocation API trong HTML5 làm gì?', 3, 'LTW001', 1, 'GVBM001', 1, 'mcq'),
(16, 'Box model trong CSS bao gồm những gì?', 2, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(17, 'Flexbox được sử dụng để làm gì?', 2, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(18, 'Grid layout trong CSS hoạt động thế nào?', 3, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(19, 'Cách định dạng văn bản trong CSS?', 1, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(20, 'Thuộc tính position trong CSS có những giá trị nào?', 2, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(21, 'Pseudo-class trong CSS là gì?', 2, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(22, 'Cách sử dụng media queries?', 2, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(23, 'Thuộc tính z-index dùng để làm gì?', 3, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(24, 'Cách tạo animation trong CSS?', 3, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(25, 'CSS preprocessor như SASS có lợi ích gì?', 3, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(26, 'Cách sử dụng biến trong CSS?', 2, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(27, 'Float trong CSS dùng để làm gì?', 2, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(28, 'Cách căn giữa phần tử trong CSS?', 2, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(29, 'Pseudo-element trong CSS là gì?', 3, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(30, 'Cách sử dụng box-shadow trong CSS?', 2, 'LTW001', 2, 'GVBM001', 1, 'mcq'),
(31, 'Hàm addEventListener trong JavaScript làm gì?', 2, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(32, 'DOM là gì trong JavaScript?', 2, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(33, 'Cách xử lý sự kiện click trong JavaScript?', 1, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(34, 'Promise trong JavaScript là gì?', 3, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(35, 'Async/await trong JavaScript dùng để gì?', 3, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(36, 'Cách thao tác với DOM trong JavaScript?', 2, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(37, 'Hàm fetch trong JavaScript dùng để gì?', 3, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(38, 'Cách xử lý lỗi trong JavaScript?', 2, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(39, 'Closure trong JavaScript là gì?', 3, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(40, 'Cách sử dụng arrow function?', 2, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(41, 'Event bubbling trong JavaScript là gì?', 3, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(42, 'Cách sử dụng setTimeout?', 2, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(43, 'JSON trong JavaScript là gì?', 2, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(44, 'Cách ngăn chặn hành vi mặc định của sự kiện?', 2, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(45, 'Cách sử dụng localStorage?', 2, 'LTW001', 3, 'GVBM001', 1, 'mcq'),
(46, 'React là framework hay thư viện?', 3, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(47, 'Vue.js có đặc điểm gì nổi bật?', 3, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(48, 'Angular khác React như thế nào?', 3, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(49, 'Redux trong React dùng để làm gì?', 3, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(50, 'Cách sử dụng component trong React?', 2, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(51, 'Vue Router dùng để làm gì?', 2, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(52, 'Cách quản lý trạng thái trong Angular?', 3, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(53, 'React Hooks là gì?', 3, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(54, 'Cách sử dụng props trong React?', 2, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(55, 'Vuex trong Vue.js dùng để gì?', 3, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(56, 'Cách xử lý form trong React?', 2, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(57, 'Next.js có lợi ích gì?', 3, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(58, 'Cách tích hợp API trong Vue.js?', 2, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(59, 'Svelte khác React như thế nào?', 3, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(60, 'Cách tối ưu hóa hiệu suất trong React?', 3, 'LTW001', 4, 'GVBM001', 1, 'mcq'),
(61, 'Responsive design được thực hiện thế nào?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(62, 'Bootstrap là gì?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(63, 'Cách sử dụng media queries trong CSS?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(64, 'Breakpoint trong responsive design là gì?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(65, 'Cách thiết kế giao diện cho mobile?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(66, 'Tailwind CSS có ưu điểm gì?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(67, 'Cách sử dụng rem và em trong CSS?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(68, 'Viewport trong thiết kế web là gì?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(69, 'Cách tối ưu hóa hình ảnh cho web?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(70, 'Accessibility trong thiết kế web là gì?', 3, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(71, 'Cách sử dụng ARIA trong HTML?', 3, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(72, 'Cách thiết kế giao diện tối giản?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(73, 'UX và UI khác nhau như thế nào?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(74, 'Cách sử dụng wireframe trong thiết kế?', 2, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(75, 'Công cụ nào dùng để thiết kế giao diện?', 3, 'LTW001', 5, 'GVBM001', 1, 'mcq'),
(76, 'Cơ sở dữ liệu quan hệ là gì?', 1, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(77, 'Khóa chính trong bảng có vai trò gì?', 1, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(78, 'Khóa ngoại trong cơ sở dữ liệu là gì?', 1, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(79, 'RDBMS là gì?', 1, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(80, 'Hệ quản trị cơ sở dữ liệu nào phổ biến?', 2, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(81, 'Cơ sở dữ liệu phân cấp là gì?', 2, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(82, 'Cơ sở dữ liệu mạng là gì?', 2, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(83, 'Ưu điểm của cơ sở dữ liệu quan hệ?', 2, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(84, 'Nhược điểm của cơ sở dữ liệu quan hệ?', 2, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(85, 'Cách lưu trữ dữ liệu trong RDBMS?', 2, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(86, 'Khái niệm schema trong cơ sở dữ liệu?', 2, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(87, 'CSDL dùng để làm gì trong ứng dụng?', 2, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(88, 'Dữ liệu có cấu trúc là gì?', 1, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(89, 'Dữ liệu phi cấu trúc là gì?', 1, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(90, 'CSDL giúp gì trong quản lý doanh nghiệp?', 2, 'CSDL001', 6, 'GVBM001', 1, 'mcq'),
(91, 'Chuẩn hóa cơ sở dữ liệu là gì?', 2, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(92, 'Dạng chuẩn 1NF yêu cầu gì?', 2, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(93, 'Dạng chuẩn 2NF yêu cầu gì?', 2, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(94, 'Dạng chuẩn 3NF yêu cầu gì?', 2, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(95, 'BCNF là gì?', 3, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(96, 'Lợi ích của chuẩn hóa cơ sở dữ liệu?', 2, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(97, 'Nhược điểm của chuẩn hóa quá mức?', 3, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(98, 'Cách thiết kế ERD trong cơ sở dữ liệu?', 2, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(99, 'Entity trong ERD là gì?', 1, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(100, 'Relationship trong ERD là gì?', 1, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(101, 'Cardinality trong ERD là gì?', 2, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(102, 'Cách chuyển ERD sang bảng quan hệ?', 2, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(103, 'Thuộc tính trong ERD là gì?', 1, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(104, 'Weak entity trong ERD là gì?', 3, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(105, 'Công cụ nào dùng để thiết kế ERD?', 2, 'CSDL001', 7, 'GVBM001', 1, 'mcq'),
(106, 'Câu lệnh SELECT trong SQL làm gì?', 1, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(107, 'Cách sử dụng JOIN trong SQL?', 2, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(108, 'Trigger trong SQL dùng để làm gì?', 3, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(109, 'Câu lệnh INSERT trong SQL làm gì?', 1, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(110, 'Câu lệnh UPDATE trong SQL làm gì?', 1, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(111, 'Câu lệnh DELETE trong SQL làm gì?', 1, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(112, 'INNER JOIN khác LEFT JOIN như thế nào?', 2, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(113, 'Cách sử dụng GROUP BY trong SQL?', 2, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(114, 'Hàm COUNT trong SQL dùng để gì?', 1, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(115, 'Hàm SUM trong SQL dùng để gì?', 1, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(116, 'Subquery trong SQL là gì?', 3, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(117, 'Cách sử dụng HAVING trong SQL?', 2, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(118, 'Câu lệnh ORDER BY trong SQL làm gì?', 1, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(119, 'Stored Procedure trong SQL là gì?', 3, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(120, 'Cách sử dụng DISTINCT trong SQL?', 2, 'CSDL001', 8, 'GVBM001', 1, 'mcq'),
(121, 'Transaction trong cơ sở dữ liệu là gì?', 2, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(122, 'ACID trong cơ sở dữ liệu nghĩa là gì?', 3, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(123, 'Commit trong transaction làm gì?', 2, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(124, 'Rollback trong transaction làm gì?', 2, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(125, 'Cách đảm bảo tính toàn vẹn dữ liệu?', 2, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(126, 'Concurrency control trong CSDL là gì?', 3, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(127, 'Deadlock trong cơ sở dữ liệu là gì?', 3, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(128, 'Khóa trong cơ sở dữ liệu là gì?', 2, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(129, 'Isolation trong ACID nghĩa là gì?', 3, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(130, 'Cách ngăn chặn SQL injection?', 3, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(131, 'Backup cơ sở dữ liệu là gì?', 2, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(132, 'Recovery trong cơ sở dữ liệu là gì?', 2, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(133, 'Cách mã hóa dữ liệu trong CSDL?', 3, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(134, 'Role trong cơ sở dữ liệu là gì?', 2, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(135, 'Cách phân quyền trong cơ sở dữ liệu?', 2, 'CSDL001', 9, 'GVBM001', 1, 'mcq'),
(136, 'Index trong cơ sở dữ liệu có lợi ích gì?', 2, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(137, 'Query nào giúp tối ưu hóa tìm kiếm?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(138, 'Clustered index là gì?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(139, 'Non-clustered index là gì?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(140, 'Nhược điểm của index trong CSDL?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(141, 'Cách tối ưu hóa câu lệnh SELECT?', 2, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(142, 'Explain plan trong SQL là gì?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(143, 'Cách sử dụng hint trong SQL?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(144, 'Tối ưu hóa join trong SQL như thế nào?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(145, 'Covering index là gì?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(146, 'Cách giảm thiểu full table scan?', 2, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(147, 'Query execution plan là gì?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(148, 'Cách phân tích hiệu suất truy vấn?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(149, 'Index fragmentation là gì?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(150, 'Cách rebuild index trong SQL?', 3, 'CSDL001', 10, 'GVBM001', 1, 'mcq'),
(151, 'Cơ sở dữ liệu NoSQL khác SQL thế nào?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(152, 'MongoDB thuộc loại cơ sở dữ liệu nào?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(153, 'Cơ sở dữ liệu tài liệu là gì?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(154, 'Cơ sở dữ liệu cột là gì?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(155, 'Cơ sở dữ liệu đồ thị là gì?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(156, 'Ưu điểm của NoSQL so với SQL?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(157, 'Nhược điểm của NoSQL?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(158, 'Cách lưu trữ dữ liệu trong MongoDB?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(159, 'BSON trong MongoDB là gì?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(160, 'Cách truy vấn trong MongoDB?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(161, 'Redis thuộc loại cơ sở dữ liệu nào?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(162, 'Cách sử dụng key-value store?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(163, 'NoSQL phù hợp với ứng dụng nào?', 2, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(164, 'Sharding trong NoSQL là gì?', 3, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(165, 'Replication trong NoSQL là gì?', 3, 'CSDL001', 11, 'GVBM001', 1, 'mcq'),
(166, 'Cơ sở dữ liệu phân tán là gì?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(167, 'CAP theorem trong CSDL là gì?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(168, 'Consistency trong CSDL phân tán là gì?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(169, 'Availability trong CSDL phân tán là gì?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(170, 'Partition tolerance là gì?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(171, 'Hệ CSDL nào hỗ trợ phân tán tốt?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(172, 'Cách thiết kế CSDL phân tán?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(173, 'Sharding trong CSDL phân tán là gì?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(174, 'Replication trong CSDL phân tán là gì?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(175, 'Eventual consistency là gì?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(176, 'Cách xử lý xung đột dữ liệu trong CSDL phân tán?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(177, 'CSDL phân tán khác NoSQL như thế nào?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(178, 'Công cụ nào dùng cho CSDL phân tán?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(179, 'Hadoop HDFS dùng để làm gì?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(180, 'Apache Cassandra có đặc điểm gì?', 3, 'CSDL001', 12, 'GVBM001', 1, 'mcq'),
(181, 'Trí tuệ nhân tạo là gì?', 1, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(182, 'Phân biệt AI, ML và DL?', 2, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(183, 'Ứng dụng thực tiễn của AI là gì?', 1, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(184, 'AI mạnh và AI yếu khác nhau thế nào?', 2, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(185, 'Lịch sử phát triển của AI?', 1, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(186, 'Turing Test trong AI là gì?', 2, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(187, 'AI được ứng dụng trong ngành nào?', 1, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(188, 'Ethics trong AI là gì?', 3, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(189, 'AI có thể thay thế con người không?', 3, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(190, 'AI cần dữ liệu gì để hoạt động?', 2, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(191, 'Machine Learning là gì?', 1, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(192, 'Deep Learning là gì?', 2, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(193, 'AI có những nhánh nào?', 2, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(194, 'Cách AI học từ dữ liệu?', 2, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(195, 'Big Data liên quan đến AI thế nào?', 2, 'TTNT001', 13, 'GVBM001', 1, 'mcq'),
(196, 'Học có giám sát là gì?', 2, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(197, 'Học không giám sát là gì?', 2, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(198, 'Học tăng cường là gì?', 2, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(199, 'Hồi quy tuyến tính thuộc loại học nào?', 2, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(200, 'Phân loại trong học máy là gì?', 2, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(201, 'Overfitting trong học máy là gì?', 3, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(202, 'Underfitting trong học máy là gì?', 3, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(203, 'Cách đánh giá mô hình học máy?', 2, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(204, 'Cross-validation trong học máy là gì?', 3, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(205, 'Decision Tree trong học máy là gì?', 2, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(206, 'Random Forest là gì?', 3, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(207, 'SVM trong học máy là gì?', 3, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(208, 'K-means clustering là gì?', 2, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(209, 'Cách xử lý dữ liệu mất cân bằng?', 3, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(210, 'Feature engineering trong học máy là gì?', 3, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(211, 'Mạng nơ-ron nhân tạo hoạt động thế nào?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(212, 'Hàm kích hoạt trong mạng nơ-ron là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(213, 'Backpropagation trong học sâu là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(214, 'CNN trong học sâu là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(215, 'RNN trong học sâu là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(216, 'LSTM trong mạng nơ-ron là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(217, 'GAN trong học sâu là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(218, 'Dropout trong mạng nơ-ron là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(219, 'Batch normalization là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(220, 'Cách tối ưu hóa mạng nơ-ron?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(221, 'Gradient descent là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(222, 'Adam optimizer là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(223, 'Transfer learning trong học sâu là gì?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(224, 'Cách xử lý overfitting trong học sâu?', 3, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(225, 'TensorFlow là gì?', 2, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(226, 'NLP được ứng dụng trong lĩnh vực nào?', 2, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(227, 'Chatbot sử dụng công nghệ gì?', 2, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(228, 'Tokenization trong NLP là gì?', 2, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(229, 'Word embedding trong NLP là gì?', 3, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(230, 'BERT trong NLP là gì?', 3, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(231, 'Sentiment analysis trong NLP là gì?', 2, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(232, 'POS tagging trong NLP là gì?', 3, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(233, 'Named Entity Recognition là gì?', 3, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(234, 'Machine translation trong NLP là gì?', 2, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(235, 'Cách xử lý văn bản trong NLP?', 2, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(236, 'TF-IDF trong NLP là gì?', 3, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(237, 'Ứng dụng của NLP trong chatbot?', 2, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(238, 'Cách huấn luyện mô hình NLP?', 3, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(239, 'Stop words trong NLP là gì?', 2, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(240, 'Cách đánh giá mô hình NLP?', 3, 'TTNT001', 16, 'GVBM001', 1, 'mcq'),
(241, 'Thị giác máy tính dùng để làm gì?', 2, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(242, 'CNN trong thị giác máy tính là gì?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(243, 'Object detection trong thị giác máy tính là gì?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(244, 'Image segmentation là gì?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(245, 'YOLO trong thị giác máy tính là gì?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(246, 'Cách nhận diện khuôn mặt?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(247, 'Ứng dụng của thị giác máy tính?', 2, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(248, 'Cách xử lý hình ảnh trong thị giác máy tính?', 2, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(249, 'Feature extraction trong thị giác máy tính là gì?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(250, 'OpenCV dùng để làm gì?', 2, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(251, 'Cách huấn luyện mô hình thị giác máy tính?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(252, 'Data augmentation trong thị giác máy tính là gì?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(253, 'Cách đánh giá mô hình thị giác máy tính?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(254, 'Transfer learning trong thị giác máy tính là gì?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(255, 'VGG16 là gì?', 3, 'TTNT001', 17, 'GVBM001', 1, 'mcq'),
(256, 'Hệ thống chuyên gia có đặc điểm gì?', 3, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(257, 'Hệ thống chuyên gia dùng để làm gì?', 2, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(258, 'Knowledge base trong hệ thống chuyên gia là gì?', 2, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(259, 'Inference engine trong hệ thống chuyên gia là gì?', 3, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(260, 'Ứng dụng của hệ thống chuyên gia?', 2, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(261, 'Hệ thống chuyên gia khác AI như thế nào?', 3, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(262, 'Rule-based system là gì?', 2, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(263, 'Cách xây dựng hệ thống chuyên gia?', 3, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(264, 'Hạn chế của hệ thống chuyên gia?', 3, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(265, 'Hệ thống chuyên gia trong y tế là gì?', 2, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(266, 'Expert system khác học máy như thế nào?', 3, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(267, 'Cách cập nhật knowledge base?', 2, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(268, 'Ứng dụng của hệ thống chuyên gia trong tài chính?', 2, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(269, 'Hệ thống chuyên gia dùng ngôn ngữ nào?', 2, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(270, 'Công cụ nào dùng để xây dựng hệ thống chuyên gia?', 3, 'TTNT001', 18, 'GVBM001', 1, 'mcq'),
(271, 'AI được ứng dụng trong y tế như thế nào?', 2, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(272, 'AI trong tự động lái xe hoạt động thế nào?', 3, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(273, 'AI trong thương mại điện tử làm gì?', 2, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(274, 'AI trong giáo dục được ứng dụng ra sao?', 2, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(275, 'AI trong an ninh mạng làm gì?', 3, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(276, 'AI trong nông nghiệp được ứng dụng thế nào?', 2, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(277, 'AI trong sản xuất hoạt động ra sao?', 3, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(278, 'AI trong tài chính làm gì?', 2, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(279, 'AI trong logistics được ứng dụng thế nào?', 2, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(280, 'AI trong chăm sóc khách hàng làm gì?', 2, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(281, 'AI trong trò chơi điện tử hoạt động ra sao?', 2, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(282, 'Hạn chế của AI trong thực tiễn?', 3, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(283, 'Cách đánh giá hiệu quả ứng dụng AI?', 3, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(284, 'AI trong xử lý hình ảnh y khoa là gì?', 3, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(285, 'AI trong dự báo thời tiết hoạt động thế nào?', 3, 'TTNT001', 19, 'GVBM001', 1, 'mcq'),
(286, 'Dart là ngôn ngữ lập trình loại nào?', 1, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(287, 'Flutter khác React Native như thế nào?', 2, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(288, 'Ưu điểm của Flutter trong lập trình di động?', 1, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(289, 'Dart hỗ trợ lập trình hướng đối tượng không?', 1, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(290, 'Flutter dùng để phát triển ứng dụng gì?', 1, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(291, 'Hot reload trong Flutter là gì?', 2, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(292, 'Flutter SDK bao gồm những gì?', 2, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(293, 'Cách cài đặt Flutter trên máy tính?', 1, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(294, 'Công cụ nào dùng để phát triển Flutter?', 2, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(295, 'Flutter có hỗ trợ đa nền tảng không?', 1, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(296, 'Nhược điểm của Flutter là gì?', 2, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(297, 'Flutter khác native app như thế nào?', 2, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(298, 'Dart có hỗ trợ async programming không?', 2, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(299, 'Widget trong Flutter là gì?', 1, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(300, 'Cách tạo dự án Flutter mới?', 1, 'LTDD001', 20, 'GVBM001', 1, 'mcq'),
(301, 'Cú pháp biến trong Dart là gì?', 1, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(302, 'Async/await trong Dart dùng để làm gì?', 2, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(303, 'Class trong Dart được định nghĩa thế nào?', 1, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(304, 'Hàm trong Dart hoạt động ra sao?', 1, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(305, 'Null safety trong Dart là gì?', 2, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(306, 'Cách sử dụng list trong Dart?', 1, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(307, 'Map trong Dart là gì?', 1, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(308, 'Cách xử lý lỗi trong Dart?', 2, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(309, 'Future trong Dart là gì?', 2, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(310, 'Stream trong Dart là gì?', 3, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(311, 'Cách sử dụng const trong Dart?', 1, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(312, 'Mixin trong Dart là gì?', 3, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(313, 'Cách sử dụng enum trong Dart?', 2, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(314, 'Extension trong Dart là gì?', 3, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(315, 'Cách sử dụng generic trong Dart?', 3, 'LTDD001', 21, 'GVBM001', 1, 'mcq'),
(316, 'StatelessWidget và StatefulWidget khác nhau ra sao?', 2, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(317, 'Cách tạo giao diện với Flutter?', 1, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(318, 'MaterialApp trong Flutter là gì?', 1, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(319, 'Scaffold trong Flutter dùng để gì?', 1, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(320, 'Cách sử dụng Row và Column trong Flutter?', 1, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(321, 'Stack trong Flutter dùng để gì?', 2, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(322, 'Cách sử dụng ListView trong Flutter?', 2, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(323, 'Container trong Flutter là gì?', 1, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(324, 'Cách sử dụng Text widget trong Flutter?', 1, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(325, 'GestureDetector trong Flutter là gì?', 2, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(326, 'Cách tạo button trong Flutter?', 1, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(327, 'Cách sử dụng Image widget?', 1, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(328, 'AppBar trong Flutter dùng để gì?', 1, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(329, 'Cách sử dụng Navigator trong Flutter?', 2, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(330, 'Cách tạo animation trong Flutter?', 3, 'LTDD001', 22, 'GVBM001', 1, 'mcq'),
(331, 'Provider trong Flutter dùng để làm gì?', 2, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(332, 'Bloc pattern trong Flutter hoạt động thế nào?', 3, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(333, 'Riverpod trong Flutter là gì?', 3, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(334, 'Cách quản lý trạng thái toàn cục?', 2, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(335, 'GetX trong Flutter dùng để gì?', 3, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(336, 'Cách sử dụng StreamBuilder trong Flutter?', 3, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(337, 'Cách xử lý sự kiện trong Flutter?', 2, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(338, 'Cách sử dụng InheritedWidget?', 3, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(339, 'ChangeNotifier trong Flutter là gì?', 2, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(340, 'Cách tối ưu hóa trạng thái trong Flutter?', 3, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(341, 'StatefulWidget dùng khi nào?', 2, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(342, 'Cách sử dụng setState trong Flutter?', 2, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(343, 'ValueNotifier trong Flutter là gì?', 3, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(344, 'Cách sử dụng FutureBuilder trong Flutter?', 2, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(345, 'Cách xử lý lỗi trong quản lý trạng thái?', 3, 'LTDD001', 23, 'GVBM001', 1, 'mcq'),
(346, 'Cách gọi API trong Flutter?', 2, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(347, 'Firebase tích hợp với Flutter như thế nào?', 3, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(348, 'Package http trong Flutter dùng để gì?', 2, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(349, 'Cách sử dụng Dio trong Flutter?', 2, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(350, 'Cách tích hợp Firestore trong Flutter?', 3, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(351, 'REST API trong Flutter hoạt động thế nào?', 2, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(352, 'Cách lưu trữ dữ liệu cục bộ trong Flutter?', 2, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(353, 'SharedPreferences trong Flutter là gì?', 2, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(354, 'Cách sử dụng SQLite trong Flutter?', 3, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(355, 'Hive trong Flutter là gì?', 3, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(356, 'Cách tích hợp push notification trong Flutter?', 3, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(357, 'Cách sử dụng GraphQL trong Flutter?', 3, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(358, 'Cách xử lý dữ liệu JSON trong Flutter?', 2, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(359, 'Cách tích hợp Google Maps trong Flutter?', 3, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(360, 'Cách tích hợp authentication trong Flutter?', 3, 'LTDD001', 24, 'GVBM001', 1, 'mcq'),
(361, 'Cách kiểm thử unit test trong Flutter?', 2, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(362, 'Công cụ nào dùng để triển khai ứng dụng Flutter?', 3, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(363, 'Integration test trong Flutter là gì?', 3, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(364, 'Widget test trong Flutter là gì?', 2, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(365, 'Cách sử dụng package test trong Flutter?', 2, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(366, 'Cách debug ứng dụng Flutter?', 2, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(367, 'Flutter DevTools dùng để gì?', 3, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(368, 'Cách tối ưu hóa hiệu suất ứng dụng Flutter?', 3, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(369, 'Cách xuất bản ứng dụng lên Play Store?', 3, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(370, 'Cách xuất bản ứng dụng lên App Store?', 3, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(371, 'Code signing trong Flutter là gì?', 3, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(372, 'Cách xử lý lỗi trong ứng dụng Flutter?', 2, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(373, 'Cách tối ưu hóa kích thước ứng dụng Flutter?', 3, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(374, 'Cách sử dụng profiling trong Flutter?', 3, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(375, 'Cách kiểm tra hiệu suất ứng dụng Flutter?', 3, 'LTDD001', 25, 'GVBM001', 1, 'mcq'),
(376, 'Trong trí tuệ nhân tạo, thuật toán nào sau đây được sử dụng để tìm kiếm tối ưu trong không gian trạng thái?\n', 1, 'TTNT001', 14, 'GVBM001', 1, 'mcq'),
(377, 'Thuật toán học máy nào sau đây thường được sử dụng cho bài toán phân loại?\n', 1, 'TTNT001', 15, 'GVBM001', 1, 'mcq'),
(378, 'Trong quá trình huấn luyện mạng CNN, việc sử dụng padding giúp:', 1, 'TEST2025', 27, 'GVBM001', 1, 'mcq'),
(380, 'Giao thức SMTP thường dùng làm gì?\n', 1, 'MMT001', 32, 'GVBM001', 0, 'mcq'),
(381, 'Giao thức SMTP thường dùng làm gì?\n', 1, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(382, 'Giao thức BGP (Border Gateway Protocol) thuộc loại giao thức định tuyến:', 1, 'MMT001', 32, 'GVBM001', 0, 'mcq'),
(383, 'Giao thức BGP (Border Gateway Protocol) thuộc loại giao thức định tuyến:', 1, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(384, 'Giao thức TCP đảm bảo việc truyền dữ liệu bằng cách:', 1, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(385, 'Trong IPv4, subnet mask 255.255.255.0 tương ứng với CIDR:', 2, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(386, 'Địa chỉ IPv6 dài:', 3, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(387, 'Mục đích của NAT (Network Address Translation) là:', 1, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(388, 'Trong mô hình Client-Server, Client đóng vai trò:', 2, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(389, 'Giao thức HTTPS sử dụng giao thức bảo mật nào?', 3, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(390, 'Thiết bị nào định tuyến gói tin giữa các mạng khác nhau?', 1, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(391, 'Trong Ethernet, tốc độ truyền phổ biến hiện nay là:', 2, 'MMT001', 32, 'GVBM001', 0, 'mcq'),
(392, 'ARP (Address Resolution Protocol) dùng để:', 2, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(393, 'Thiết bị nào trong mạng Wi-Fi đóng vai trò phát sóng?', 3, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(394, 'Mô hình OSI có bao nhiêu tầng?', 1, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(395, 'Giao thức HTTP hoạt động ở tầng nào của mô hình OSI?', 2, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(396, 'Địa chỉ IPv4 có độ dài bao nhiêu bit?', 3, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(397, 'Đơn vị nhỏ nhất để truyền dữ liệu trong mạng máy tính gọi là:', 1, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(398, 'Địa chỉ MAC thuộc tầng nào của mô hình OSI?', 2, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(399, 'Trong mạng LAN, thiết bị nào dùng để kết nối nhiều máy tính lại với nhau?', 3, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(400, 'Giao thức FTP được dùng để:', 1, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(401, 'Cổng mặc định của HTTP là:', 1, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(402, 'DNS dùng để:', 2, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(403, 'Ký hiệu “192.168.0.1” là loại địa chỉ IP:', 3, 'MMT001', 32, 'GVBM001', 1, 'mcq'),
(404, 'thang thuan bao nhiem cm\n', 3, 'MMT001', 32, 'GVBM001', 1, 'essay');
...
--
ALTER TABLE `cauhoi`
  MODIFY `macauhoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=405;

--
-- AUTO_INCREMENT cho bảng `cautraloi`
--
ALTER TABLE `cautraloi`
  MODIFY `macautl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1610;
