            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent bg-white mb-0">
                    <ul class="nav nav-tabs nav-tabs-alt" role="tablist">
                        ...
                        <li class="nav-item">
    <button class="nav-link" id="ma-lop-tab" data-bs-toggle="tab" data-bs-target="#ma-lop"
        role="tab" aria-controls="ma-lop" aria-selected="false">
        Thêm theo mã lớp
    </button>
</li>
                    ...
                    <div class="tab-pane fade fade-up" id="them-file-excel" role="tabpanel"
                        ...
                        <form id="form-upload" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <em>Vui lòng soạn người dùng theo đúng định dạng. <a href="./public/filemau/danhsachsv_cntt2211.xls">Tải về file mẫu
                                        </a></em>
                            </div>
                    ...
                    <div class="tab-pane fade fade-up" id="ma-lop" role="tabpanel"
    aria-labelledby="ma-lop-tab" tabindex="0">
    <form id="addSvByClassCode">
        <div class="mb-3">
        ...
        <div class="block-content block-content-full text-end">
            ...
            <button type="submit" class="btn btn-sm btn-primary">Thêm sinh viên</button>
        </div>
        <input type="hidden" name="manhom" id="manhom-hidden">
        ...
        <div class="block block-transparent pull-x pull-t mb-0">
            <ul class="nav nav-tabs nav-tabs-block nav-justified" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link action" id="so-settings-tab" data-bs-toggle="tab"
