            ...
            <form class="block block-rounded form-tao-de" novalidate="novalidate">
                ...
                <div class="block block-content">
                    ...
                    <div class="mb-4">
                        <?php
                            if ($data["Action"] == "create") {
                                echo '<button type="submit" class="btn btn-hero btn-primary" id="btn-send-announcement"><i class="fa fa-fw fa-plus me-1"></i>Gửi thông báo</button>';
                            } elseif ($data["Action"] == "update") {
                                echo '<button type="submit" class="btn btn-hero btn-primary" id="btn-update-announce"><i class="fa fa-fw fa-plus me-1"></i>Cập nhật thông báo</button>';
                            }
                    ?>
                    </div>
                </div>
